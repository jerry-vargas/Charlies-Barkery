...
CREATE TABLE `formie_fieldlayout_pages` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_csqpcpicywhsbzkxfzubktxsjpziatrkzvym` (`layoutId`),
  CONSTRAINT `fk_nhzlpsgmdvufmahvipveuqxndnncziwfjokk` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_fieldlayout_rows` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_uhfyxvnbaydrnwmfoztpvspafjrhusjrndzn` (`layoutId`),
  KEY `idx_bbjhcqcxvkjwbxrvmhtvnfjmxhanhurntruf` (`pageId`),
  CONSTRAINT `fk_eglfidilpvjmvuabvhkvvbkxvsxehmonivhk` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_onophkmlpevlgdkhijmfpvdectsehhdszofs` FOREIGN KEY (`pageId`) REFERENCES `formie_fieldlayout_pages` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_fields` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_itojnyumkiydylllwazlwjyylciwycjilndy` (`layoutId`),
  KEY `idx_pffosukueyalwyikdghgcydpovhtpxtrvkcn` (`pageId`),
  KEY `idx_cabyywmyxtuelqhakqgkqrdracrxkexkwgcg` (`rowId`),
  KEY `idx_rgfmaalgecldpqiohlcfepjvlcqhkzsysanp` (`syncId`),
  KEY `idx_uccvxxbznwmhfoytjykarcizbjrvhlruxbyc` (`handle`),
  CONSTRAINT `fk_fbmybygzxhdhiinvsosfbcnszrwwpxwrtcoi` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_jujbjahpedydfmkenscoeicrzpzxifyrywwh` FOREIGN KEY (`pageId`) REFERENCES `formie_fieldlayout_pages` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_qgucnyhuvbxkpguhgvjiporipqiunlgvygws` FOREIGN KEY (`syncId`) REFERENCES `formie_fields` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_qokkzaabkwnugkjgxwlpheoacztenjlrgwhd` FOREIGN KEY (`rowId`) REFERENCES `formie_fieldlayout_rows` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_forms` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_lucelpkytptriemmdoftbfxrqqqvqyqpdmsg` (`layoutId`),
  KEY `idx_iltwisbznyyiqootfpqohdbqhhtnvdaoewsj` (`templateId`),
  KEY `idx_pnseuwfzsccnfomwdvyubdwopojbgqljczmm` (`defaultStatusId`),
  KEY `idx_clrtkmyjptkfepinadwoqirienmjoyoptdhv` (`submitActionEntryId`),
  KEY `idx_ymmvuvcgzqwbotcvzbamdfaawqbcyhdtvbpo` (`submitActionEntrySiteId`),
  CONSTRAINT `fk_cvviqwpypntpxkewpezgrfqcqgtoanyedtst` FOREIGN KEY (`templateId`) REFERENCES `formie_formtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_dnfzffudtnqtjdmnhfdpfsyjjrxtlnraiwge` FOREIGN KEY (`submitActionEntryId`) REFERENCES `entries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_mzrkgjokauxvpslrdfvcmyciqtajudeocxod` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_oregrawnlxgpwoxgpjkstemfddhkglovrhcy` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_wmudljzxgxantqstfebobniqxtyzmthevvxs` FOREIGN KEY (`defaultStatusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_formtemplates` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_orkdpndzymuugpyaeuzpxlufhobunrddamua` (`fieldLayoutId`),
  CONSTRAINT `fk_xhbwxdgitnparggdzxfkzfybyrsdxafcnnzj` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_notifications` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_whweaoxycnauchcagozmohkcgjufclifnbfj` (`formId`),
  KEY `idx_luuzwuqwdpfyjwgvtezywxslrdnlrucnspux` (`templateId`),
  KEY `fk_vuddarewsgfmphtoldlglqcmedxdoxwiyfpo` (`pdfTemplateId`),
  CONSTRAINT `fk_giaookdxobtmknlmctalvegrkaudqgknnseh` FOREIGN KEY (`templateId`) REFERENCES `formie_emailtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ndlnfhvfpbfqrnpxbqporfwlypajyyocizej` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_vuddarewsgfmphtoldlglqcmedxdoxwiyfpo` FOREIGN KEY (`pdfTemplateId`) REFERENCES `formie_pdftemplates` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_payments` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_ryuztjcqusqaxaxleyiqdbwrstbtdznubxxx` (`integrationId`),
  KEY `idx_gurpnqmmobeefctxjkdmnvblmaajslrwvzwe` (`fieldId`),
  KEY `idx_fsbkamezmomchcrjfuexnroamokgslkimhxk` (`reference`),
  KEY `fk_bewarjanzkkfsbuwfunrkeyiyewduepexpyb` (`submissionId`),
  KEY `fk_mkutndrbehbhpegzsvxwgxhfmwbmuniaoumv` (`subscriptionId`),
  CONSTRAINT `fk_bewarjanzkkfsbuwfunrkeyiyewduepexpyb` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_jyqiraqhjxrsdfbgykpsvridbwpvkafzqvjz` FOREIGN KEY (`integrationId`) REFERENCES `formie_integrations` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_mkutndrbehbhpegzsvxwgxhfmwbmuniaoumv` FOREIGN KEY (`subscriptionId`) REFERENCES `formie_payments_subscriptions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_xxnbqchhkfwlucwopyljerptawzzubcwzqjz` FOREIGN KEY (`fieldId`) REFERENCES `formie_fields` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_payments_plans` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_sezamxqizmimredcynyosuajzinnrcrakajm` (`handle`),
  KEY `idx_oygakxgnpcjkxlcpdeavqrhtfjgtsppmxkgl` (`integrationId`),
  KEY `idx_ldbaoxhacqyjhicerbokbzefvkxdgtcdwutv` (`reference`),
  CONSTRAINT `fk_ouyfyxdvpseoleidlnyfbpvmitvxeokrimbm` FOREIGN KEY (`integrationId`) REFERENCES `formie_integrations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_payments_subscriptions` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_wnwbqzompxlekuqtjskkroikrytggicfmcmj` (`integrationId`),
  KEY `idx_vhasrjlvcouaqpkrfjhztjtyppdbgxqylcxa` (`submissionId`),
  KEY `idx_proodqriclzyvpwjunthitarsvljurhaibpd` (`fieldId`),
  KEY `idx_qmxpkfejskegwkfavzykevpebrdqoxafteeo` (`planId`),
  KEY `idx_hrrglzgkftqmzqusoffkgvjppilysuvqzudr` (`reference`),
  KEY `idx_zepfvtpwdbfebwtcozllwsxkhtixwokpsoaw` (`nextPaymentDate`),
  KEY `idx_rueaothwfxajrkkvnfqaovqgfrnhedstvqgu` (`dateExpired`),
  KEY `idx_naxagvughyshkqocchvwvrfvhpxferhqavjz` (`dateExpired`),
  CONSTRAINT `fk_nfphtbkxrqlnwxuhontrkogoypjfndhmpuox` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_oolzdqjhmmlxhiodhblocfierbuttzdsroei` FOREIGN KEY (`planId`) REFERENCES `formie_payments_plans` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_srlbhpxegewlrceicpzrtkysotqyczidurae` FOREIGN KEY (`integrationId`) REFERENCES `formie_integrations` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_yoinowfbejinymwrxzojoqvmghzrfihdtzqo` FOREIGN KEY (`fieldId`) REFERENCES `formie_fields` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_relations` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_iukkiuzqwoavxaxxdqcrmeuigbeclgsdwuml` (`sourceId`,`sourceSiteId`,`targetId`),
  KEY `idx_prweymefedanakgthlcnbseqwyxqptopgkxx` (`sourceId`),
  KEY `idx_ysjjgstowydnzkogcyqwqfbufexugelvihlp` (`targetId`),
  KEY `idx_ywvdkkdhoaopivwfkudvrvyvtuxoseuwrevt` (`sourceSiteId`),
  CONSTRAINT `fk_arbecplmolvawwtqwaryzwqnctrjbjokoqsw` FOREIGN KEY (`targetId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_cadrlkobtcqjlcnlvigidoecdhoaiopdqahx` FOREIGN KEY (`sourceSiteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_tsphhxlxrwrnjkmbhjfkjsalmkgypupdzxvz` FOREIGN KEY (`sourceId`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_sentnotifications` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_vkcuevahzvsbpygmjftxvsyjolrkundswjry` (`formId`),
  KEY `fk_pzqstqdcvsegeiddjowqmyfgptqozwdjbmxp` (`submissionId`),
  KEY `fk_nizwwsonatpyiaipimpvhedadjzpqqvtpvcv` (`notificationId`),
  CONSTRAINT `fk_ihhkzwyzloifaoggnstswnywdsxveowoesrh` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_nizwwsonatpyiaipimpvhedadjzpqqvtpvcv` FOREIGN KEY (`notificationId`) REFERENCES `formie_notifications` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_pzqstqdcvsegeiddjowqmyfgptqozwdjbmxp` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_vkcuevahzvsbpygmjftxvsyjolrkundswjry` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_stencils` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_ndnlytgdjshbpsnjsikgycmbotvpnqgtyihl` (`templateId`),
  KEY `idx_evfflwuawfkzvvhfcffcoduvpsogamdiguos` (`defaultStatusId`),
  CONSTRAINT `fk_etinffxxejporyjaaijsjzdhfyskndolfuiy` FOREIGN KEY (`templateId`) REFERENCES `formie_formtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_repepkputadmxsgliaekjfbypcqjedederqf` FOREIGN KEY (`defaultStatusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_submissions` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_bvasnobxszryskgkmdgwdnvsvbrztxcthkvp` (`formId`),
  KEY `idx_shnydkgwlvfiedjjfwndxqwpmxgxijwycnxl` (`statusId`),
  KEY `idx_lcapqaydhcuhcubedmibseclziefzmgyjxtv` (`userId`),
  CONSTRAINT `fk_hwnghtnwaowqhstdeqvigsnvqzqzjptwlyrs` FOREIGN KEY (`statusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_jlbmevjyvjfkpnbdkchllcxrbwhwzvwfpdnj` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_mezrhotxegvqieakurrdngzfmxwefqwwovgo` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_zfknwjeboxqhqgpgpjvhwxhdmsldfhunzxxn` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-06  9:13:38
-- MySQL dump 10.13  Distrib 8.0.40, for Linux (aarch64)
--
-- Host: db    Database: db
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `elementactivity` VALUES (3,1,1,NULL,'edit','2026-04-04 04:42:24'),(3,1,1,NULL,'save','2026-04-04 04:42:32'),(3,1,1,NULL,'view','2026-05-06 13:13:02');
...
set autocommit=0;
INSERT INTO `formie_statuses` VALUES (1,'New','new','green',NULL,1,1,NULL,'2026-05-06 12:39:09','2026-05-06 12:39:09','c58d7339-c7da-48b0-a338-3835c34549f1');
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'5.9.22','5.9.0.8',0,'zfqtvapqwmpi','3@bivpiwwcae','2026-03-12 17:35:44','2026-05-06 12:39:13','bdb1fde7-0ca3-4ae0-9d78-8b50b127bbd3');
...
set autocommit=0;
INSERT INTO `plugins` VALUES (1,'commerce','5.6.0','5.6.1.1','2026-03-12 17:49:17','2026-03-12 17:49:17','2026-05-06 12:35:07','fc99f9b1-ebab-48f9-8746-3501fdf82681'),(2,'vite','5.0.1','1.0.0','2026-03-12 18:04:30','2026-03-12 18:04:30','2026-03-12 18:04:30','5a4488a1-979f-4c7a-9e26-4804ac550b89'),(3,'ckeditor','5.3.1','5.0.0.1','2026-03-28 22:40:42','2026-03-28 22:40:42','2026-05-06 12:35:07','d9905813-3e3b-4c5c-8f19-3ca20e3a289b'),(5,'aws-s3','2.3.0','2.0','2026-05-06 12:18:48','2026-05-06 12:18:48','2026-05-06 12:18:48','bdfc8324-ea23-4f46-b933-9bb64212ac27'),(6,'formie','3.1.23','3.4.12','2026-05-06 12:39:07','2026-05-06 12:39:07','2026-05-06 12:39:07','50cc7ad8-ab33-43e7-9d7b-56f722789b0d');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,NULL,NULL,1,0,0,0,1,'admin',NULL,NULL,NULL,'jerry@charliesbarkery.com','$2y$13$W2qAPsTYHkeqfNKZNsh6F.x9w0kwBwf0UD0yM1m5vLCa7qTw0R7JC','2026-05-06 11:40:25',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,0,'2026-03-12 17:35:46','2026-03-12 17:35:46','2026-05-06 11:40:25');
...
-- Dump completed on 2026-05-06  9:13:39
