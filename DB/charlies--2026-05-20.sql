...
CREATE TABLE `ckeditor_references` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fieldId` int NOT NULL,
  `fieldInstanceUid` char(36) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `formie_forms` (
  ...
  `dataRetention` enum('forever','minutes','hours','days','weeks','months','years') COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'forever',
  `dataRetentionValue` int DEFAULT NULL,
  `userDeletedAction` enum('retain','delete') COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'retain',
  `fileUploadsAction` enum('retain','delete') COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'retain',
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `formie_formtemplates` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(64) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `template` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  ...
  `outputCssLocation` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `outputJsLocation` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `fieldLayoutId` int DEFAULT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
...
CREATE TABLE `formie_notifications` (
  ...
  `recipients` enum('email','conditions') COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'email',
  `to` text COLLATE utf8mb4_unicode_520_ci,
  `toConditions` text COLLATE utf8mb4_unicode_520_ci,
  `cc` text COLLATE utf8mb4_unicode_520_ci,
  `bcc` text COLLATE utf8mb4_unicode_520_ci,
  `replyTo` text COLLATE utf8mb4_unicode_520_ci,
  `replyToName` text COLLATE utf8mb4_unicode_520_ci,
  `from` text COLLATE utf8mb4_unicode_520_ci,
  `fromName` text COLLATE utf8mb4_unicode_520_ci,
  `sender` text COLLATE utf8mb4_unicode_520_ci,
  `content` text COLLATE utf8mb4_unicode_520_ci,
  `attachFiles` tinyint(1) DEFAULT '1',
  `attachPdf` tinyint(1) DEFAULT '0',
  `attachAssets` text COLLATE utf8mb4_unicode_520_ci,
  `enableConditions` tinyint(1) DEFAULT '0',
  `conditions` text COLLATE utf8mb4_unicode_520_ci,
  `customSettings` text COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `formie_payments` (
  ...
  `code` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `message` text COLLATE utf8mb4_unicode_520_ci,
  `redirectUrl` text COLLATE utf8mb4_unicode_520_ci,
  `note` mediumtext COLLATE utf8mb4_unicode_520_ci,
  `response` text COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `formie_pdftemplates` (
  ...
  `handle` varchar(64) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `template` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `filenameFormat` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `formie_sentnotifications` (
  ...
  `htmlBody` mediumtext COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `formie_submissions` (
  ...
  `spamReason` text COLLATE utf8mb4_unicode_520_ci,
  `spamClass` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `snapshot` text COLLATE utf8mb4_unicode_520_ci,
  `ipAddress` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-05-20  9:25:10
-- MySQL dump 10.13  Distrib 8.0.40, for Linux (aarch64)
--
-- Host: db    Database: db
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `elementactivity` VALUES (1,1,1,NULL,'view','2026-05-16 01:35:34'),(3,1,1,NULL,'edit','2026-05-16 01:47:28'),(3,1,1,NULL,'save','2026-05-16 01:47:33'),(3,1,1,NULL,'view','2026-05-20 13:03:07'),(249,1,1,NULL,'edit','2026-05-09 21:08:28'),(249,1,1,NULL,'view','2026-05-09 21:12:25'),(286,1,1,NULL,'edit','2026-05-09 21:12:23'),(286,1,1,NULL,'view','2026-05-09 21:12:27'),(295,1,1,NULL,'edit','2026-05-09 21:12:31'),(295,1,1,NULL,'view','2026-05-09 21:12:25'),(328,1,1,NULL,'edit','2026-05-20 13:37:50'),(328,1,1,NULL,'save','2026-05-20 13:38:09'),(328,1,1,NULL,'view','2026-05-20 14:07:47'),(366,1,1,NULL,'edit','2026-05-12 01:24:14'),(366,1,1,N
,3),(57,3,4),(64,3,4),(139,164,4),(139,168,4),(139,174,4),(139,177,4),(147,146,4),(153,152,4),(159,158,4),(159,161,4),(159,162,4),(182,181,4),(188,187,4),(194,193,4),(200,199,4),(200,202,4),(200,206,4),(200,209,4),(200,215,4),(200,221,4),(200,231,4),(200,234,4),(200,235,4),(200,236,4),(200,240,4),(200,250,4),(200,255,4),(200,256,4),(200,260,4),(200,263,4),(200,266,4),(200,267,4),(200,268,4),(200,269,4),(200,273,4),(200,279,4),(200,287,4),(200,296,4),(200,309,4),(200,318,4),(200,324,4),(200,327,4),(422,328,4),(459,511,4),(459,527,4),(459,607,4),(459,613,4),(459,616,4),(459,622,4),(475,468,4),(475,490,4),(475,535,4),(475,543,4),(475,547,4),(475,553,4),(475,580,4),(475,600,4),(475,601,4),(506,505,4),(525,504,4),(533,529,4),(577,542,4),(586,582,4),(229,3,5),(232,231,5),(232,234,5),(232,235,5),(232,236,5),(241,240,5),(241,255,5),(241,256,5),(241,260,5),(241,263,5),(241,266,5),(241,267,5),(241,268,5),(241,269,5),(241,273,5),(241,279,5),(241,287,5),(241,296,5),(241,309,5),(241,318,5),(241,324,5),(241,327,5),(241,468,5),(241,490,5),(241,535,5),(241,543,5),(241,547,5),(241,553,5),(241,580,5),(241,600,5),(241,601,5),(251,250,5),(526,504,5),(534,529,5),(578,542,5),(587,582,5),(605,328,5),(608,607,5),(614,613,5),(614,616,5),(623,622,5),(241,250,6),(247,3,6),(251,255,6),(251,256,6),(261,260,6),(264,263,6),(264,266,6),(264,267,6),(264,268,6),(264,269,6),(274,273,6),(280,279,6),(288,287,6),(297,296,6),(310,309,6),(319,318,6),(325,324,6),(325,327,6),(481,468,6),(491,490,6),(491,535,6),(491,543,6),(491,547,6),(491,553,6),(491,580,6),(491,600,6),(491,601,6),(579,542,6),(588,582,6),(540,3,7),(544,543,7),(544,547,7),(554,553,7),(581,580,7),(581,600,7),(581,601,7);
...
set autocommit=0;
INSERT INTO `entries_authors` VALUES (328,1,1),(329,1,1),(330,1,1),(331,1,1),(333,1,1),(369,1,1),(378,1,1),(381,1,1),(388,1,1),(396,1,1),(405,1,1),(411,1,1),(414,1,1),(416,1,1),(424,1,1),(432,1,1),(438,1,1),(444,1,1),(454,1,1),(493,1,1),(497,1,1),(505,1,1),(511,1,1),(527,1,1),(589,1,1),(590,1,1),(596,1,1),(599,1,1),(607,1,1),(613,1,1),(616,1,1),(622,1,1),(634,1,1),(640,1,1);
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'5.10.1','5.10.0.0',0,'rlotumiplapa','3@ccnbmpibrz','2026-03-12 17:35:44','2026-05-20 13:02:39','bdb1fde7-0ca3-4ae0-9d78-8b50b127bbd3');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,NULL,NULL,1,0,0,0,1,'admin',NULL,NULL,NULL,'jerry@charliesbarkery.com','$2y$13$W2qAPsTYHkeqfNKZNsh6F.x9w0kwBwf0UD0yM1m5vLCa7qTw0R7JC','2026-05-20 12:35:03',NULL,NULL,NULL,'2026-05-16 00:56:30',NULL,1,NULL,NULL,NULL,0,'2026-03-12 17:35:46','2026-03-12 17:35:46','2026-05-20 12:35:03');
...
-- Dump completed on 2026-05-20  9:25:11
