...
CREATE TABLE `addresses` (
  ...
  `countryCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `administrativeArea` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `locality` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `dependentLocality` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `postalCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `sortingCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `addressLine1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `addressLine2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `addressLine3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `organization` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `organizationTaxId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  ...
  `latitude` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `longitude` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `announcements` (
  ...
  `heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `assetindexdata` (
  ...
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `assetindexingsessions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `indexedVolumes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `assets` (
  ...
  `mimeType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `kind` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'unknown',
  `alt` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `width` int unsigned DEFAULT NULL,
  `height` int unsigned DEFAULT NULL,
  `size` bigint unsigned DEFAULT NULL,
  `focalPoint` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `auth_oauth_tokens` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ownerHandle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `providerType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `tokenType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `accessToken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `secret` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `expires` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `refreshToken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `resourceOwnerId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `values` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `authenticator` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `auth2faSecret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `bulkopevents` (
  `key` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `senderClass` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `eventName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `categorygroups` (
  ...
  `handle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `defaultPlacement` enum('beginning','end') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'end',
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `categorygroups_sites` (
  ...
  `uriFormat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `template` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `changedfields` (
  ...
  `layoutElementUid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  `dateUpdated` datetime NOT NULL,
  `propagated` tinyint(1) NOT NULL,
  `userId` int DEFAULT NULL,
...
CREATE TABLE `ckeditor_references` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fieldId` int NOT NULL,
  `fieldInstanceUid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  `sourceId` int NOT NULL,
  `sourceSiteId` int DEFAULT NULL,
  `targetId` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_ngoovkzksloibupkepnobplwislpncligrub` (`fieldId`,`fieldInstanceUid`,`sourceId`,`sourceSiteId`,`targetId`),
  KEY `idx_fddlesvradxyamfsfydfhohthtihtcyhqtpx` (`targetId`),
  KEY `fk_hhebgjcurerscvwmmiodvleohdqlmsiepfph` (`sourceId`),
  KEY `fk_hxibexohpzhungqfkufhbkkwruclreqzystp` (`sourceSiteId`),
  CONSTRAINT `fk_gcugbubdhlgqhaufvfwmbamwlxvwnvnwkvjb` FOREIGN KEY (`fieldId`) REFERENCES `fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_hhebgjcurerscvwmmiodvleohdqlmsiepfph` FOREIGN KEY (`sourceId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_hxibexohpzhungqfkufhbkkwruclreqzystp` FOREIGN KEY (`sourceSiteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `commerce_catalogpricingrules` (
  ...
  `dateFrom` datetime DEFAULT NULL,
  `dateTo` datetime DEFAULT NULL,
  `apply` enum('toPercent','toFlat','byPercent','byFlat') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `applyAmount` decimal(14,4) NOT NULL,
  `applyPriceType` enum('price','promotionalPrice') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `productCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `variantCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `purchasableCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `customerCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `commerce_coupons` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `commerce_discount_purchasables` (
  ...
  `discountId` int NOT NULL,
  `purchasableId` int NOT NULL,
  `purchasableType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `commerce_discounts` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `couponFormat` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '######',
  `orderCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `customerCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `shippingAddressCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `billingAddressCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `percentageOffSubject` enum('original','discounted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  ...
  `purchasableIds` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `allCategories` tinyint(1) NOT NULL DEFAULT '0',
  `categoryIds` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `appliedTo` enum('matchingLineItems','allLineItems') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'matchingLineItems',
  `categoryRelationshipType` enum('element','sourceElement','targetElement') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'element',
  `orderConditionFormula` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `commerce_donations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `commerce_emails` (
  ...
  `storeId` int DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `senderAddress` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `senderName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `recipientType` enum('customer','custom') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT 'custom',
  `to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `bcc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `cc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `replyTo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `templatePath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `plainTextTemplatePath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `commerce_gateways` (
  ...
  `paymentType` enum('authorize','purchase') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'purchase',
  `isFrontendEnabled` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '1',
  `orderCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `shippingAddressCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `billingAddressCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `commerce_inventoryitems` (
  `id` int NOT NULL AUTO_INCREMENT,
  `purchasableId` int NOT NULL,
  `countryCodeOfOrigin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `administrativeAreaCodeOfOrigin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `harmonizedSystemCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `commerce_inventorytransactions` (
  ...
  `movementHash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `quantity` int NOT NULL,
  `type` enum('incoming','available','committed','reserved','damaged','safety','fulfilled','qualityControl') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `commerce_lineitems` (
  ...
  `type` enum('purchasable','custom') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'purchasable',
  ...
  `optionsSignature` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  ...
  `privateNote` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `snapshot` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `commerce_lineitemstatuses` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `color` enum('green','orange','red','blue','yellow','pink','purple','turquoise','light','grey','black') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'green',
  `isArchived` tinyint(1) NOT NULL DEFAULT '0',
  `dateArchived` datetime DEFAULT NULL,
  `sortOrder` int DEFAULT NULL,
...
CREATE TABLE `commerce_orderadjustments` (
  ...
  `sourceSnapshot` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `commerce_ordernotices` (
  ...
  `attribute` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `commerce_orders` (
  ...
  `number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `couponCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  ...
  `paidStatus` enum('paid','partial','unpaid','overPaid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `orderCompletedEmail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `isCompleted` tinyint(1) NOT NULL DEFAULT '0',
  `dateOrdered` datetime DEFAULT NULL,
  `datePaid` datetime DEFAULT NULL,
  `dateFirstPaid` datetime DEFAULT NULL,
  `dateAuthorized` datetime DEFAULT NULL,
  `currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `paymentCurrency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `lastIp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `orderLanguage` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `origin` enum('web','cp','remote') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'web',
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `recalculationMode` enum('all','none','adjustmentsOnly') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'all',
  `returnUrl` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `cancelUrl` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `shippingMethodHandle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
  `shippingMethodName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
...
CREATE TABLE `commerce_paymentcurrencies` (
  `id` int NOT NULL AUTO_INCREMENT,
  `storeId` int NOT NULL,
  `iso` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `commerce_pdfs` (
  ...
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `templatePath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `fileNameFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `paperOrientation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT 'portrait',
  `paperSize` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT 'letter',
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `commerce_plans` (
  ...
  `planData` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `isArchived` tinyint(1) NOT NULL DEFAULT '0',
  `dateArchived` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `commerce_products` (
  ...
  `defaultSku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `commerce_producttypes` (
  ...
  `variantTitleFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `variantTitleTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `variantTitleTranslationKeyFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `variantUiLabelFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '{title}',
  `hasProductTitleField` tinyint(1) NOT NULL DEFAULT '1',
  `productTitleFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `productTitleTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `productTitleTranslationKeyFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `productUiLabelFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '{title}',
  `showSlugField` tinyint(1) NOT NULL DEFAULT '1',
  `slugTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `slugTranslationKeyFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `propagationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'all',
  `previewTargets` json DEFAULT NULL,
  `skuFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `descriptionFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `commerce_shippingrule_categories` (
  ...
  `shippingCategoryId` int DEFAULT NULL,
  `condition` enum('allow','disallow','require') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `commerce_shippingzones` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `default` tinyint(1) NOT NULL DEFAULT '0',
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `commerce_stores` (
  ...
  `currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'USD',
  `autoSetCartShippingMethodOption` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `autoSetNewCartAddresses` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `autoSetPaymentSource` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `allowEmptyCartOnCheckout` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `allowCheckoutWithoutPayment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `allowPartialPaymentOnCheckout` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `requireShippingAddressAtCheckout` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `requireBillingAddressAtCheckout` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `requireShippingMethodSelectionAtCheckout` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `useBillingAddressForTax` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `validateOrganizationTaxIdAsVatId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'false',
  `orderReferenceFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `freeOrderPaymentStrategy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT 'complete',
  `minimumTotalPriceStrategy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT 'default',
  `sortOrder` int DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `commerce_storesettings` (
  ...
  `countries` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `marketAddressCondition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `commerce_subscriptions` (
  ...
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `subscriptionData` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `commerce_taxrates` (
  ...
  `taxIdValidators` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `removeIncluded` tinyint(1) NOT NULL DEFAULT '0',
  `removeVatIncluded` tinyint(1) NOT NULL DEFAULT '0',
  `taxable` enum('purchasable','price','shipping','price_shipping','order_total_shipping','order_total_price') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `commerce_transactions` (
  ...
  `gatewayId` int DEFAULT NULL,
  `userId` int DEFAULT NULL,
  `hash` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `type` enum('authorize','capture','purchase','refund') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `amount` decimal(14,4) DEFAULT NULL,
  `paymentAmount` decimal(14,4) DEFAULT NULL,
  `currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `paymentCurrency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `paymentRate` decimal(14,4) DEFAULT NULL,
  `status` enum('pending','redirect','success','failed','processing') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `note` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `response` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `commerce_transferdetails` (
  ...
  `inventoryItemDescription` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `quantity` int NOT NULL,
...
CREATE TABLE `commerce_transfers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `transferStatus` enum('draft','pending','partial','received') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `craftidtokens` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `accessToken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `expiryDate` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `elements_sites` (
  ...
  `uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `entries` (
  ...
  `postDate` datetime DEFAULT NULL,
  `expiryDate` datetime DEFAULT NULL,
  `status` enum('live','pending','expired') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'live',
...
CREATE TABLE `entrytypes` (
  ...
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `uiLabelFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '{title}',
  `hasTitleField` tinyint(1) NOT NULL DEFAULT '1',
  `titleTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `titleTranslationKeyFormat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `titleFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `allowLineBreaksInTitles` tinyint(1) NOT NULL DEFAULT '0',
  `showSlugField` tinyint(1) DEFAULT '1',
  `slugTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `slugTranslationKeyFormat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `fields` (
  ...
  `handle` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `context` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'global',
  `columnSuffix` char(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `instructions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `searchable` tinyint(1) NOT NULL DEFAULT '1',
  `translationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'none',
  `translationKeyFormat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `settings` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `formie_emailtemplates` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `formie_fieldlayout_pages` (
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_nsqrexlmxmjvnahygpqrainzbagkjvshiecw` (`layoutId`),
  CONSTRAINT `fk_gknxwdmycbxehijuliklrspwerfqeqcgrbug` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE CASCADE
...
CREATE TABLE `formie_fieldlayout_rows` (
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_icpiquamphxteenxcldudixvlmwtrtanuqga` (`layoutId`),
  KEY `idx_hjcjqplmmlzmqlqzajlttpcogkzprsbeafmp` (`pageId`),
  CONSTRAINT `fk_gzstcpvgdrxrxhitrbkrsufpaesvvcpmskyc` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ujwtjnsoucqxtvxglcwuxovxmtejnwezjvpa` FOREIGN KEY (`pageId`) REFERENCES `formie_fieldlayout_pages` (`id`) ON DELETE CASCADE
...
CREATE TABLE `formie_fields` (
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_wxedmlcgpghzgrtvlvpwxbdmezqlpdwyaylc` (`layoutId`),
  KEY `idx_ideqamesflunfjabaybeamfobtxmgnzcyqxa` (`pageId`),
  KEY `idx_siiaxqkjsboedqjawdbdugaejbmpmvmsxynh` (`rowId`),
  KEY `idx_wpwuifezoiqrojqmpqloxupwiisbrwdgttsk` (`syncId`),
  KEY `idx_amdejzjmlzwudspzdreaycgwddbxllefezmt` (`handle`),
  CONSTRAINT `fk_bftpiskczhqjszwtuoibhdqoxkfbarrddmkn` FOREIGN KEY (`pageId`) REFERENCES `formie_fieldlayout_pages` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_enrndujfqpdatpfhrsqhyymfgtfuuypcjetz` FOREIGN KEY (`rowId`) REFERENCES `formie_fieldlayout_rows` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_mirswwkaayipduvfaurmwovywrhzrxukslag` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_sgbdfouczclhiboxyrosnguzwactzbowntes` FOREIGN KEY (`syncId`) REFERENCES `formie_fields` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_forms` (
  ...
  `dataRetention` enum('forever','minutes','hours','days','weeks','months','years') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'forever',
  `dataRetentionValue` int DEFAULT NULL,
  `userDeletedAction` enum('retain','delete') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'retain',
  `fileUploadsAction` enum('retain','delete') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'retain',
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_sboppsoomxhgzkwfrcgqfvczzguzepglowce` (`layoutId`),
  KEY `idx_esethrboanvzxudvqqehaktrkefkxzqwxxwp` (`templateId`),
  KEY `idx_znwzoduhtoplxrylokazkragluaygxeihdwh` (`defaultStatusId`),
  KEY `idx_qynovuzgzrrnuiwlluiarnpuoztsprpdbbam` (`submitActionEntryId`),
  KEY `idx_kllxmnkosbxcupvyobgxvjhomvvgocrhettn` (`submitActionEntrySiteId`),
  CONSTRAINT `fk_dinzriavgbphvcmnluziplmgwyhdjrjpnejw` FOREIGN KEY (`layoutId`) REFERENCES `formie_fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_eertronpkdhrvyjtuppfagqqlrnfqslsrgfz` FOREIGN KEY (`defaultStatusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_muqizowkakmpqvetsealvuyjbindtxhfqyws` FOREIGN KEY (`submitActionEntryId`) REFERENCES `entries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_nzfkvyoledinjymbfxiznsojhnuwvobvvzov` FOREIGN KEY (`templateId`) REFERENCES `formie_formtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_znewhrvbfqjgoouwjbmamsnyykqzbmdwvgdo` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=643 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_formtemplates` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  ...
  `outputCssLocation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `outputJsLocation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `fieldLayoutId` int DEFAULT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_xyweuwhxcjyqnibzqysquwmvkhrvoxufxftr` (`fieldLayoutId`),
  CONSTRAINT `fk_emmdmfpuxbjzpxskaxfeibppjcddxwmfitpd` FOREIGN KEY (`fieldLayoutId`) REFERENCES `fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_integrations` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `enabled` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'true',
  `settings` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `formie_notifications` (
  ...
  `recipients` enum('email','conditions') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'email',
  `to` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `toConditions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `cc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `bcc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `replyTo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `replyToName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `from` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `fromName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `sender` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `attachAssets` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `enableConditions` tinyint(1) DEFAULT '0',
  `conditions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `customSettings` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_llqpijekxegxalhgeiikomgnpydopubqgkkh` (`formId`),
  KEY `idx_yfltyobhfgrivdxrwxodoajtxysmotuozywq` (`templateId`),
  KEY `fk_bmodbzdjqqjapkscdyczxfizwmokfnktfgjg` (`pdfTemplateId`),
  CONSTRAINT `fk_bmodbzdjqqjapkscdyczxfizwmokfnktfgjg` FOREIGN KEY (`pdfTemplateId`) REFERENCES `formie_pdftemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_famkwfhtyjtkhbabzpywhduqdgkimkjipnpn` FOREIGN KEY (`templateId`) REFERENCES `formie_emailtemplates` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_teewsbwzzypmpsyzxjushodxglifthfbmxjm` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_payments` (
  ...
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `redirectUrl` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `note` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `response` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_clgphyidkyjmwoyegrkjukfzfhhoycgkjmdo` (`integrationId`),
  KEY `idx_ynxqajbeppbnpfqgnprfczpslsntmowwhvbv` (`fieldId`),
  KEY `idx_bynektlrbxnllvyiceclxgdcfcvunkxyyroe` (`reference`),
  KEY `fk_vlsalnssppcubkhkpgtkpjveyiokntslkhkd` (`submissionId`),
  KEY `fk_hsxtzttojgwuofsgfjsvwujyeepzawnrboiq` (`subscriptionId`),
  CONSTRAINT `fk_hsxtzttojgwuofsgfjsvwujyeepzawnrboiq` FOREIGN KEY (`subscriptionId`) REFERENCES `formie_payments_subscriptions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_kjktnhoenlajnrfctzjfhyeobxxhktkdpzsp` FOREIGN KEY (`integrationId`) REFERENCES `formie_integrations` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_onnyqaqdtirxpwvkxxpsexqpmaqsbtizpyzx` FOREIGN KEY (`fieldId`) REFERENCES `formie_fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_vlsalnssppcubkhkpgtkpjveyiokntslkhkd` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_payments_plans` (
  ...
  `integrationId` int NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_jnswiapzlmrwwixepfsmrshulqsepxnvvbbc` (`handle`),
  KEY `idx_uudnhdvhlbhuthqynsldvxefxrzerddmthcg` (`integrationId`),
  KEY `idx_zeovayzokbddrtemteezyniwmldtbkppmend` (`reference`),
  CONSTRAINT `fk_zbrvvqmengvehsatcdlspwaenejixadoislx` FOREIGN KEY (`integrationId`) REFERENCES `formie_integrations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_payments_subscriptions` (
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_gmgrrxjkmhfddbijvmunsktyjqeeelvisgep` (`integrationId`),
  KEY `idx_cwhfzcyyytrbnwdkxbmcxypcrqbefsgthoff` (`submissionId`),
  KEY `idx_owqamrfejbcjwewpznrqxmrmswfpxvvontsu` (`fieldId`),
  KEY `idx_tpptmnrfzcgumhfbrfqmuyufwjsdtnucgotv` (`planId`),
  KEY `idx_wuuqqlqnmhefctkpmvchdethfgvwdsaeirhw` (`reference`),
  KEY `idx_auhmtliabfpnippaointgjhcokquolwvzytp` (`nextPaymentDate`),
  KEY `idx_buikhxfffsoroejzvzpjrbhzhyxkacmfutes` (`dateExpired`),
  KEY `idx_rmbozdcaxqntpqtmbvkfkoqomryrptmshgrf` (`dateExpired`),
  CONSTRAINT `fk_tjfmmydusrwsslfczcedfrwwvbbwtvmxqfgi` FOREIGN KEY (`integrationId`) REFERENCES `formie_integrations` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_ttgdfyurjqoscqflxliedpfsjoscinbaqybm` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_wqfelewbitewuojwipquvnfvewpdnjtslccg` FOREIGN KEY (`fieldId`) REFERENCES `formie_fields` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_zjfeapebtcpgimndmttknopxucvslgdiwsvj` FOREIGN KEY (`planId`) REFERENCES `formie_payments_plans` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_pdftemplates` (
  ...
  `handle` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `template` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `filenameFormat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `formie_relations` (
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_poadoetbfhjtekvaykmvwtunqqhhlurhafbh` (`sourceId`,`sourceSiteId`,`targetId`),
  KEY `idx_ojysiqqaxtmidzwsgtdgctyqchmuvfegphjz` (`sourceId`),
  KEY `idx_arfjiwdidycpxhldidzjzihpdnezbykvvxyl` (`targetId`),
  KEY `idx_qedxssrxyydtiyldilwqpacniwlkayfstelr` (`sourceSiteId`),
  CONSTRAINT `fk_jsqswsnodnxuozdwpytbyzfzflweadrrcsex` FOREIGN KEY (`sourceId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_qkuxishejfqqkxqtwjirkbsbjcojamyplndl` FOREIGN KEY (`targetId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_qwlualelhprnalkkcccczcnkulafeimtemwh` FOREIGN KEY (`sourceSiteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_sentnotifications` (
  ...
  `fromName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `sender` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `body` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `htmlBody` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_hdyhpopgmolmbkfpkxcoxfwqcttbqpmdmxtw` (`formId`),
  KEY `fk_nholpkmqxoauxabxarovkmlbmgpcubwacngw` (`submissionId`),
  KEY `fk_tsaxtpgvdfwouclkfirmhokfovecrhowcjdn` (`notificationId`),
  CONSTRAINT `fk_hdyhpopgmolmbkfpkxcoxfwqcttbqpmdmxtw` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_nholpkmqxoauxabxarovkmlbmgpcubwacngw` FOREIGN KEY (`submissionId`) REFERENCES `formie_submissions` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_sloiwrbcfdmevkaatnmlsowlxglpusfjjtpi` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_tsaxtpgvdfwouclkfirmhokfovecrhowcjdn` FOREIGN KEY (`notificationId`) REFERENCES `formie_notifications` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_stencils` (
  ...
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_gkjpawroenqrmkfxbutndthtqpolawfdsmor` (`templateId`),
  KEY `idx_szdqejfzjrvgvqdltftxmuebjgsrigtqdeax` (`defaultStatusId`),
  CONSTRAINT `fk_sktcbprcjlduxqabbpiqpauzuqvvtjmhvyrl` FOREIGN KEY (`defaultStatusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_zgbxphepqruennjespedxrnavhxapcgirslc` FOREIGN KEY (`templateId`) REFERENCES `formie_formtemplates` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formie_submissions` (
  ...
  `spamReason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `spamClass` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `snapshot` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `ipAddress` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_chjmvmpwkxfxcgjmjyvjdzzyfotcivsdmvbe` (`formId`),
  KEY `idx_sgflnktqbuwulxapehvjmsnjvxwfcjxagvqe` (`statusId`),
  KEY `idx_clmehrldkhqldfzkqoveitcqluqerxieumzc` (`userId`),
  CONSTRAINT `fk_bcecdlbugyfpsdweotadvsaandrnuylyzydj` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_dsonlvgyugpouqncdstsvshnbgsrbvdszmdd` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_gnmoytyawacsmpdljdajjxgjanlhiiqeezdb` FOREIGN KEY (`formId`) REFERENCES `formie_forms` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_nwqyajxpbrdrmxhrdpeuphlnoxwjenjbuozt` FOREIGN KEY (`statusId`) REFERENCES `formie_statuses` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gqltokens` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `accessToken` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `expiryDate` datetime DEFAULT NULL,
...
CREATE TABLE `imagetransformindex` (
  `id` int NOT NULL AUTO_INCREMENT,
  `assetId` int NOT NULL,
  `transformer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `filename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `format` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `transformString` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `imagetransforms` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `mode` enum('stretch','fit','crop','letterbox') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'crop',
  `position` enum('top-left','top-center','top-right','center-left','center-center','center-right','bottom-left','bottom-center','bottom-right') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'center-center',
  `width` int unsigned DEFAULT NULL,
  `height` int unsigned DEFAULT NULL,
  `format` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `quality` int DEFAULT NULL,
  `interlace` enum('none','line','plane','partition') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'none',
  `fill` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `info` (
  ...
  `schemaVersion` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `maintenance` tinyint(1) NOT NULL DEFAULT '0',
  `configVersion` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '000000000000',
  `fieldVersion` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '000000000000',
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `migrations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `track` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `plugins` (
  ...
  `schemaVersion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `queue` (
  `id` int NOT NULL AUTO_INCREMENT,
  `channel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'queue',
  ...
  `progressLabel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1207 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recoverycodes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `recoveryCodes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
CREATE TABLE `searchindex` (
  `elementId` int NOT NULL,
  `attribute` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `fieldId` int NOT NULL,
  `siteId` int NOT NULL,
...
CREATE TABLE `searchindexqueue_fields` (
  `jobId` int NOT NULL,
  `fieldHandle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
CREATE TABLE `sections` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `type` enum('single','channel','structure') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'channel',
  `enableVersioning` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `sessions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `token` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `shunnedmessages` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `message` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `expiryDate` datetime DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `sites` (
  ...
  `hasUrls` tinyint(1) NOT NULL DEFAULT '0',
  `baseUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `dateDeleted` datetime DEFAULT NULL,
...
CREATE TABLE `sso_identities` (
  `provider` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `identityId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `userId` int NOT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
...
CREATE TABLE `tokens` (
  ...
  `route` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
...
CREATE TABLE `users` (
  ...
  `lastLoginAttemptIp` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `invalidLoginWindowStart` datetime DEFAULT NULL,
  `invalidLoginCount` tinyint unsigned DEFAULT NULL,
  `lastInvalidLoginDate` datetime DEFAULT NULL,
  `lockoutDate` datetime DEFAULT NULL,
  `hasDashboard` tinyint(1) NOT NULL DEFAULT '0',
  `verificationCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `verificationCodeIssuedDate` datetime DEFAULT NULL,
  `unverifiedEmail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `volumes` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `handle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `fs` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `subpath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `transformFs` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `transformSubpath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `titleTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `titleTranslationKeyFormat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `altTranslationMethod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'site',
  `altTranslationKeyFormat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `sortOrder` smallint unsigned DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `dateDeleted` datetime DEFAULT NULL,
...
CREATE TABLE `webauthn` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `credentialId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `credential` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `credentialName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
-- Dump completed on 2026-06-16 16:30:34
-- MySQL dump 10.13  Distrib 8.0.40, for Linux (aarch64)
--
-- Host: db    Database: db
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `assets` VALUES (300,1,3,1,'box-open.svg','image/svg+xml','image',NULL,640,640,658,NULL,NULL,NULL,'2026-05-09 21:08:23','2026-05-09 21:08:23','2026-05-09 21:08:23'),(305,1,3,1,'palette.svg','image/svg+xml','image',NULL,640,640,975,NULL,NULL,NULL,'2026-05-09 21:12:08','2026-05-09 21:12:08','2026-05-09 21:12:08'),(306,1,3,1,'calendar.svg','image/svg+xml','image',NULL,640,640,626,NULL,NULL,NULL,'2026-05-09 21:12:13','2026-05-09 21:12:13','2026-05-09 21:12:13'),(561,1,3,1,'3_cakes_v3.jpg','image/jpeg','image',NULL,3415,2277,5526054,NULL,NULL,NULL,'2026-05-16 01:44:07','2026-05-16 01:44:08','2026-05-16 01:44:08'),(562,1,3,1,'AC4E7E92-80AD-4FA1-BE87-62352FD9409F.JPG','image/jpeg','image',NULL,1440,1800,194161,NULL,NULL,NULL,'2026-05-16 01:44:09','2026-05-16 01:44:09','2026-05-16 01:44:09'),(563,1,3,1,'Charlie-Solo.jpg','image/jpeg','image',NULL,1067,1600,409651,NULL,NULL,NULL,'2026-05-16 01:44:10','2026-05-16 01:44:10','2026-05-16 01:44:10'),(564,1,3,1,'cupcackes_stacked_v2.jpg','image/jpeg','image',NULL,5754,3836,10815319,NULL,NULL,NULL,'2026-05-16 01:44:13','2026-05-16 01:44:15','2026-05-16 01:44:15'),(565,1,3,1,'ShopLocalQC_Birkdale3.9.25-91.jpg','image/jpeg','image',NULL,2891,4336,8903928,NULL,NULL,NULL,'2026-05-16 01:44:17','2026-05-16 01:44:18','2026-05-16 01:44:18'),(566,1,3,1,'ShopLocalQC_Birkdale3.9.25-346.jpg','image/jpeg','image',NULL,3294,4941,7519252,NULL,NULL,NULL,'2026-05-16 01:44:21','2026-05-16 01:44:23','2026-05-16 01:44:23'),(567,1,3,1,'SouthPark-Market-October-2025-Shop-Local-QC-Cait-Louise-Co.-284.jpg','image/jpeg','image',NULL,3506,5259,11463636,NULL,NULL,NULL,'2026-05-16 01:44:25','2026-05-16 01:44:27','2026-05-16 01:44:27'),(568,1,3,1,'The-Bowl-Market-July-2025-Shop-Local-QC-Cait-Louise-Co.-113.jpg','image/jpeg','image',NULL,2079,3118,3860697,NULL,NULL,NULL,'2026-05-16 01:44:28','2026-05-16 01:44:29','2026-05-16 01:44:29');
...
set autocommit=0;
INSERT INTO `assets_sites` VALUES (300,1,NULL),(305,1,NULL),(306,1,NULL),(561,1,NULL),(562,1,NULL),(563,1,NULL),(564,1,NULL),(565,1,NULL),(566,1,NULL),(567,1,NULL),(568,1,NULL);
...
set autocommit=0;
INSERT INTO `changedattributes` VALUES (3,1,'fieldLayoutId','2026-03-25 14:42:33',0,1),(3,1,'title','2026-03-25 14:45:23',0,1),(3,1,'typeId','2026-03-25 14:42:33',0,1),(28,1,'title','2026-03-25 15:36:14',0,1),(37,1,'primaryOwnerId','2026-06-15 21:59:08',0,1),(37,1,'title','2026-06-15 21:59:08',0,1),(44,1,'primaryOwnerId','2026-06-15 21:59:08',0,1),(44,1,'title','2026-06-15 21:59:08',0,1),(64,1,'title','2026-04-04 03:57:31',0,1),(139,1,'primaryOwnerId','2026-06-15 21:59:08',0,1),(139,1,'title','2026-06-15 21:59:08',0,1),(144,1,'title','2026-04-04 04:05:29',0,1),(229,1,'title','2026-04-04 04:42:31',0,1),(247,1,'title','2026-05-09 04:41:58',0,1),(249,1,'primaryOwnerId','2026-05-09 21:12:32',0,1),(286,1,'primaryOwnerId','2026-05-09 21:12:32',0,1),(295,1,'primaryOwnerId','2026-05-09 21:12:32',0,1),(328,1,'enabled','2026-05-12 00:31:51',0,1),(328,1,'fieldLayoutId','2026-05-12 00:44:49',0,1),(328,1,'postDate','2026-05-09 22:02:30',0,1),(328,1,'slug','2026-05-09 22:02:26',0,1),(328,1,'title','2026-05-09 22:02:30',0,1),(328,1,'typeId','2026-05-12 00:44:49',0,1),(328,1,'uri','2026-05-09 22:02:26',0,1),(330,1,'enabled','2026-05-09 22:10:25',0,1),(331,1,'enabled','2026-05-12 00:31:51',0,1),(333,1,'fieldLayoutId','2026-05-12 00:44:49',0,1),(333,1,'typeId','2026-05-12 00:44:49',0,1),(364,1,'title','2026-05-12 00:49:59',0,1),(366,1,'primaryOwnerId','2026-05-12 01:24:16',0,1),(403,1,'title','2026-05-12 01:25:47',0,1),(422,1,'title','2026-05-12 02:52:39',0,1),(503,1,'title','2026-05-12 03:41:19',0,1),(540,1,'title','2026-05-16 01:47:32',0,1),(552,1,'slug','2026-05-16 01:34:07',0,1),(552,1,'title','2026-05-16 01:34:07',0,1),(589,1,'postDate','2026-05-16 05:42:45',0,1),(589,1,'slug','2026-05-16 05:42:45',0,1),(589,1,'status','2026-05-16 05:42:45',0,1),(589,1,'title','2026-05-16 05:42:45',0,1),(589,1,'uri','2026-05-16 05:42:45',0,1),(605,1,'title','2026-06-15 21:56:39',0,1),(641,1,'title','2026-06-15 21:59:22',0,1),(642,1,'title','2026-06-15 21:54:02',0,1),(663,1,'postDate','2026-06-16 19:15:35',0,1),(663,1,'slug','2026-06-16 19:15:35',0,1),(663,1,'status','2026-06-16 19:15:35',0,1),(663,1,'title','2026-06-16 19:15:35',0,1),(663,1,'uri','2026-06-16 19:15:35',0,1);
...
set autocommit=0;
INSERT INTO `commerce_stores` VALUES (1,'Primary','primary',1,'USD','','','','','','','','','','','','{{number[:7]}}','complete','default',99,'2026-03-12 17:49:25','2026-05-20 13:02:38','645bb423-5466-4a2c-a05f-ceeb31bac6e5');
...
set autocommit=0;
INSERT INTO `drafts` VALUES (206,NULL,1,0,'First draft',NULL,0,NULL,0),(207,NULL,1,0,'First draft',NULL,0,NULL,1);
...
set autocommit=0;
INSERT INTO `elementactivity` VALUES (1,1,1,NULL,'view','2026-05-16 01:35:34'),(3,1,1,NULL,'edit','2026-06-15 21:59:05'),(3,1,1,NULL,'save','2026-06-15 21:59:07'),(3,1,1,NULL,'view','2026-06-15 21:59:08'),(249,1,1,NULL,'edit','2026-05-09 21:08:28'),(249,1,1,NULL,'view','2026-05-09 21:12:25'),(286,1,1,NULL,'edit','2026-05-09 21:12:23'),(286,1,1,NULL,'view','2026-05-09 21:12:27'),(295,1,1,NULL,'edit','2026-05-09 21:12:31'),(295,1,1,NULL,'view','2026-05-09 21:12:25'),(328,1,1,NULL,'edit','2026-06-16 19:31:08'),(328,1,1,NULL,'save','2026-06-16 19:38:00'),(328,1,1,NULL,'view','2026-06-16 19:38:01'),(366,1,1,NULL,'edit','2026-05-12 01:24:14'),(366,1,1,NULL,'view','2026-05-12 01:24:10'),(522,1,1,NULL,'view','2026-05-13 13:03:08'),(551,1,1,NULL,'view','2026-05-16 01:35:07'),(552,1,1,NULL,'save','2026-05-16 01:34:07'),(552,1,1,NULL,'view','2026-05-16 01:35:08'),(562,1,1,NULL,'view','2026-05-16 01:47:34'),(574,1,1,NULL,'view','2026-05-16 01:56:56'),(589,1,1,NULL,'edit','2026-06-16 19:38:26'),(589,1,1,NULL,'save','2026-06-16 19:38:29'),(589,1,1,NULL,'view','2026-06-16 19:41:49'),(631,1,1,NULL,'view','2026-05-20 14:24:57'),(663,1,1,NULL,'edit','2026-06-16 20:41:49'),(663,1,1,NULL,'save','2026-06-16 20:41:51'),(663,1,1,NULL,'view','2026-06-16 21:29:31');
...
set autocommit=0;
INSERT INTO `entries_authors` VALUES (328,1,1),(329,1,1),(330,1,1),(331,1,1),(333,1,1),(369,1,1),(378,1,1),(381,1,1),(388,1,1),(396,1,1),(405,1,1),(411,1,1),(414,1,1),(416,1,1),(424,1,1),(432,1,1),(438,1,1),(444,1,1),(454,1,1),(493,1,1),(497,1,1),(505,1,1),(511,1,1),(527,1,1),(589,1,1),(590,1,1),(596,1,1),(599,1,1),(607,1,1),(613,1,1),(616,1,1),(622,1,1),(634,1,1),(640,1,1),(646,1,1),(652,1,1),(663,1,1),(664,1,1),(670,1,1),(678,1,1),(679,1,1),(681,1,1),(683,1,1),(689,1,1),(706,1,1),(713,1,1),(717,1,1),(723,1,1),(726,1,1),(730,1,1);
...
set autocommit=0;
INSERT INTO `formie_fieldlayout_pages` VALUES (1,1,'Page 1',0,'{\"submitButtonLabel\":\"Count us In\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left\",\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"enableNextButtonConditions\":false,\"nextButtonConditions\":[],\"enablePageConditions\":false,\"pageConditions\":[],\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2026-06-15 20:08:27','2026-06-15 20:13:53','d134ea4b-7321-4912-9021-37efdc211fa3'),(2,2,'Page 1',0,'{\"submitButtonLabel\":\"Submit\",\"backButtonLabel\":\"Back\",\"showBackButton\":false,\"saveButtonLabel\":\"Save\",\"showSaveButton\":false,\"saveButtonStyle\":\"link\",\"buttonsPosition\":\"left\",\"cssClasses\":null,\"containerAttributes\":null,\"inputAttributes\":null,\"enableNextButtonConditions\":false,\"nextButtonConditions\":[],\"enablePageConditions\":false,\"pageConditions\":[],\"enableJsEvents\":false,\"jsGtmEventOptions\":[]}','2026-06-15 21:53:25','2026-06-15 21:53:25','13d12106-ce63-496b-9f4d-315d03997e3a');
...
set autocommit=0;
INSERT INTO `formie_fieldlayout_rows` VALUES (1,1,1,0,'2026-06-15 20:13:53','2026-06-15 20:13:53','a29fe4ac-08c8-4223-8560-be90f7eaf183'),(2,1,1,1,'2026-06-15 20:13:53','2026-06-15 20:13:53','f98d7ff4-65a7-47fc-840d-d3d271c76cc8'),(3,1,1,2,'2026-06-15 20:13:53','2026-06-15 20:13:53','a7733963-f113-4646-b590-6686e4d1c0b9'),(4,2,2,0,'2026-06-15 21:54:02','2026-06-15 21:54:02','29b077e3-641c-4d27-8863-bcb7d6f265ef'),(5,2,2,1,'2026-06-15 21:54:02','2026-06-15 21:54:02','41870781-4659-45f1-a920-a636076ef66f'),(6,2,2,2,'2026-06-15 21:54:02','2026-06-15 21:54:02','d07c83f9-1d64-49e3-8c9a-23a7d04e9924');
...
set autocommit=0;
INSERT INTO `formie_fieldlayouts` VALUES (1,'2026-06-15 20:08:27','2026-06-15 20:08:27','587f0891-2ac4-467b-80e8-5dc26c51311b'),(2,'2026-06-15 21:53:25','2026-06-15 21:53:25','b61be307-530a-44ff-b985-2f6d7db2c8c2');
...
set autocommit=0;
INSERT INTO `formie_fields` VALUES (1,1,1,1,NULL,'First Name','firstName1','verbb\\formie\\fields\\SingleLineText',0,'{\"limit\":false,\"min\":null,\"minType\":\"characters\",\"max\":null,\"maxType\":\"characters\",\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 20:13:53','2026-06-15 20:13:53','f581e324-99fd-4667-b902-599af09352ab'),(2,1,1,1,NULL,'Last Name','lastName1','verbb\\formie\\fields\\SingleLineText',1,'{\"limit\":false,\"min\":null,\"minType\":\"characters\",\"max\":null,\"maxType\":\"characters\",\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 20:13:53','2026-06-15 20:13:53','a887122c-e34c-47d4-b67b-28e2cbf20ec3'),(3,1,1,2,NULL,'Email Address','emailAddress','verbb\\formie\\fields\\Email',0,'{\"validateDomain\":false,\"blockedDomains\":[],\"blockFreeDomains\":false,\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 20:13:53','2026-06-15 20:13:53','d9e747dd-3ef2-4ed7-997c-0175403ce8e8'),(4,1,1,3,NULL,'What\'s your pup into','whatsYourPupInto','verbb\\formie\\fields\\Checkboxes',0,'{\"multi\":true,\"layout\":\"vertical\",\"toggleCheckbox\":null,\"toggleCheckboxLabel\":null,\"limitOptions\":false,\"min\":null,\"max\":null,\"instructions\":null,\"enabled\":true,\"required\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":\"label\",\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null,\"options\":[{\"label\":\"Peanut Butter\",\"value\":\"Peanut Butter\",\"isDefault\":false},{\"label\":\"Bacon\",\"value\":\"Bacon\",\"isDefault\":false},{\"label\":\"Pumpkin\",\"value\":\"Pumpkin\",\"isDefault\":false},{\"label\":\"Birthday Treats\",\"value\":\"Birthday Treats\",\"isDefault\":false},{\"label\":\"All of it\",\"value\":\"All of it\",\"isDefault\":false}]}','2026-06-15 20:13:53','2026-06-15 20:13:53','cbe20ee7-9c12-40d0-b692-4b33a7a0d18f'),(5,2,2,4,NULL,'First Name','firstName1','verbb\\formie\\fields\\SingleLineText',0,'{\"limit\":false,\"min\":null,\"minType\":\"characters\",\"max\":null,\"maxType\":\"characters\",\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 21:54:02','2026-06-15 21:54:02','0e4b5aad-8f32-4c24-a925-b6ced20d36e8'),(6,2,2,4,NULL,'Last Name','lastName1','verbb\\formie\\fields\\SingleLineText',1,'{\"limit\":false,\"min\":null,\"minType\":\"characters\",\"max\":null,\"maxType\":\"characters\",\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 21:54:02','2026-06-15 21:54:02','53421f45-947d-4ffa-a7c7-2b88e6338701'),(7,2,2,5,NULL,'Email Address','emailAddress','verbb\\formie\\fields\\Email',0,'{\"validateDomain\":false,\"blockedDomains\":[],\"blockFreeDomains\":false,\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":true,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 21:54:02','2026-06-15 21:54:02','70ff56e1-3db5-41fd-90cf-05245ebf4157'),(8,2,2,6,NULL,'Message','message','verbb\\formie\\fields\\MultiLineText',0,'{\"limit\":false,\"min\":null,\"minType\":\"characters\",\"max\":null,\"maxType\":\"characters\",\"useRichText\":false,\"richTextButtons\":[\"bold\",\"italic\"],\"plainTextPaste\":false,\"uniqueValue\":false,\"instructions\":null,\"enabled\":true,\"required\":false,\"matchField\":null,\"placeholder\":null,\"defaultValue\":null,\"prePopulate\":null,\"errorMessage\":null,\"labelPosition\":null,\"instructionsPosition\":null,\"cssClasses\":null,\"containerAttributes\":[],\"inputAttributes\":[],\"includeInEmail\":true,\"emailValue\":null,\"enableConditions\":false,\"conditions\":null,\"enableContentEncryption\":false,\"visibility\":null}','2026-06-15 21:54:02','2026-06-15 21:54:02','771d897c-0ab9-40a8-bf93-188e9662ec56');
...
set autocommit=0;
-a143-40da-b581-b33d928f7345'),(30,17,579,NULL,566,1,'2026-05-16 01:47:32','2026-05-16 01:47:32','b62fea90-2381-45be-9453-d4012d12f50f'),(31,17,583,NULL,561,1,'2026-05-16 01:47:33','2026-05-16 01:47:33','1ca58d6f-61d2-474c-bcba-37f41057ecda'),(32,17,584,NULL,568,1,'2026-05-16 01:47:33','2026-05-16 01:47:33','18912db0-f282-4a6c-af68-a8471feddd99'),(33,17,585,NULL,567,1,'2026-05-16 01:47:33','2026-05-16 01:47:33','aa1d8a19-f9c1-4f23-bf57-9b585fa9de60'),(34,17,586,NULL,564,1,'2026-05-16 01:47:33','2026-05-16 01:47:33','b335e745-90c0-464c-a581-11a5b41aa6cd'),(35,17,587,NULL,563,1,'2026-05-16 01:47:33','2026-05-16 01:47:33','cbd1ef16-8239-40b9-a26a-a1c4262a916d'),(36,17,588,NULL,566,1,'2026-05-16 01:47:33','2026-05-16 01:47:33','f5e2d39b-cf65-451d-aac3-b8cb8192b3ec'),(38,29,595,NULL,642,1,'2026-06-15 21:55:31','2026-06-15 21:55:31','f4c9a023-80c5-4737-b78d-80aefaf15387'),(39,29,648,NULL,642,1,'2026-06-15 21:55:31','2026-06-15 21:55:31','9017ff59-a45b-40c5-805d-905a1c565213'),(41,29,621,NULL,641,1,'2026-06-15 21:56:39','2026-06-15 21:56:39','5de7ecbf-d94a-4762-b22e-39e841ab5b0e'),(42,29,654,NULL,641,1,'2026-06-15 21:56:39','2026-06-15 21:56:39','272cefd6-3865-4f61-b197-165fe9aed447'),(44,29,659,NULL,641,1,'2026-06-15 21:59:07','2026-06-15 21:59:07','b89aa0d6-49b0-47c2-90b3-d3657d82b869'),(45,29,662,NULL,641,1,'2026-06-15 21:59:07','2026-06-15 21:59:07','9eb2f816-f3da-4d0b-bf94-53186af7ba83');
...
set autocommit=0;
INSERT INTO `searchindex` VALUES (1,'email',0,1,' jerry charliesbarkery com '),(1,'firstname',0,1,''),(1,'fullname',0,1,''),(1,'lastname',0,1,''),(1,'slug',0,1,''),(1,'username',0,1,' admin '),(2,'addressline1',0,1,''),(2,'addressline2',0,1,''),(2,'addressline3',0,1,''),(2,'administrativearea',0,1,''),(2,'countrycode',0,1,' us '),(2,'dependentlocality',0,1,''),(2,'fullname',0,1,''),(2,'locality',0,1,''),(2,'organization',0,1,''),(2,'organizationtaxid',0,1,''),(2,'postalcode',0,1,''),(2,'slug',0,1,''),(2,'sortingcode',0,1,''),(2,'title',0,1,' store '),(3,'slug',0,1,' home page '),(3,'title',0,1,' home page '),(28,'slug',0,1,' temp juhpquzqlrlrkshojqyuibpjewcwrrmiavbz '),(28,'title',0,1,''),(29,'slug',0,1,''),(42,'slug',0,1,' temp olptniqbrcvowkzmucejwynueaqayriksziw '),(42,'title',0,1,''),(47,'slug',0,1,''),(52,'slug',0,1,' temp rzbsvmxqlpvpseevknimnumdkivfzoibxmbb '),(52,'title',0,1,''),(57,'slug',0,1,' temp xxrsinvghpwaqytoaxnwtgwgyccxfwduxmpe '),(57,'title',0,1,''),(64,'slug',0,1,' temp etssgfgmmofjurapxtfmkrpoyidaadyzacxs '),(64,'title',0,1,''),(67,'slug',0,1,''),(144,'slug',0,1,' temp hhzrcvazyquagjeirsxdtpoymjuamcjdoznk '),(144,'title',0,1,''),(145,'slug',0,1,''),(229,'slug',0,1,' temp oatgqexjbwvdubaytzqxmvxsbnjbzlntisah '),(229,'title',0,1,''),(230,'slug',0,1,''),(247,'slug',0,1,' temp elbvgitvquqfhaaxemlchtkqwkenfzvdioty '),(247,'title',0,1,''),(248,'slug',0,1,''),(249,'slug',0,1,' bulk orders '),(249,'title',0,1,' bulk orders '),(286,'slug',0,1,' custom branding '),(286,'title',0,1,' custom branding '),(295,'slug',0,1,' events '),(295,'title',0,1,' events '),(300,'alt',0,1,''),(300,'extension',0,1,' svg '),(300,'filename',0,1,' box open svg '),(300,'kind',0,1,' image '),(300,'slug',0,1,''),(300,'title',0,1,' box open '),(305,'alt',0,1,''),(305,'extension',0,1,' svg '),(305,'filename',0,1,' palette svg '),(305,'kind',0,1,' image '),(305,'slug',0,1,''),(305,'title',0,1,' palette '),(306,'alt',0,1,''),(306,'extension',0,1,' svg '),(306,'filename',0,1,' calendar svg '),(306,'kind',0,1,' image '),(306,'slug',0,1,''),(306,'title',0,1,' calendar '),(328,'slug',0,1,' about '),(328,'title',0,1,' about '),(364,'slug',0,1,' temp bxahghshhxlymueuoxztjmsexptewuputdlr '),(364,'title',0,1,''),(365,'slug',0,1,''),(366,'slug',0,1,' real ingredients '),(366,'title',0,1,' real ingredients '),(367,'slug',0,1,' small batch always '),(367,'title',0,1,' small batch always '),(368,'slug',0,1,' made with love '),(368,'title',0,1,' made with love '),(403,'slug',0,1,' temp sxmjrksscvasfrlhdtkuzuhukvpiiskixgxy '),(403,'title',0,1,''),(404,'slug',0,1,''),(422,'slug',0,1,' temp nvjykcvwmlhafvdkeqyaiavgdwcdylszpxth '),(422,'title',0,1,''),(423,'slug',0,1,''),(503,'slug',0,1,' temp pzhaqzcsvzfvwtjuuezxvpccfbviiitqtmmv '),(503,'title',0,1,''),(504,'slug',0,1,''),(522,'slug',0,1,' 2019 '),(522,'title',0,1,' 2019 '),(523,'slug',0,1,' 2021 '),(523,'title',0,1,' 2021 '),(524,'slug',0,1,' 2022 '),(524,'title',0,1,' 2022 '),(525,'slug',0,1,' 2024 '),(525,'title',0,1,' 2024 '),(526,'slug',0,1,' now '),(526,'title',0,1,' now '),(540,'slug',0,1,' temp gitdtenuozqghtelhivhiqopsjdcdzosqrjo '),(540,'title',0,1,''),(541,'slug',0,1,''),(542,'slug',0,1,''),(561,'alt',0,1,''),(561,'extension',0,1,' jpg '),(561,'filename',0,1,' 3 cakes v3 jpg '),(561,'kind',0,1,' image '),(561,'slug',0,1,''),(561,'title',0,1,' 3 cakes v3 '),(562,'alt',0,1,''),(562,'extension',0,1,' jpg '),(562,'filename',0,1,' ac4e7e92 80ad 4fa1 be87 62352fd9409f jpg '),(562,'kind',0,1,' image '),(562,'slug',0,1,''),(562,'title',0,1,' ac4 e7 e92 80 ad 4 fa1 be87 62352 fd9409 f '),(563,'alt',0,1,''),(563,'extension',0,1,' jpg '),(563,'filename',0,1,' charlie solo jpg '),(563,'kind',0,1,' image '),(563,'slug',0,1,''),(563,'title',0,1,' charlie solo '),(564,'alt',0,1,''),(564,'extension',0,1,' jpg '),(564,'filename',0,1,' cupcackes stacked v2 jpg '),(564,'kind',0,1,' image '),(564,'slug',0,1,''),(564,'title',0,1,' cupcackes stacked v2 '),(565,'alt',0,1,''),(565,'extension',0,1,' jpg '),(565,'filename',0,1,' shoplocalqc birkdale3 9 25 91 jpg '),(565,'kind',0,1,' image '),(565,'slug',0,1,''),(565,'title',0,1,' shop local qc birkdale3 9 25 91 '),(566,'alt',0,1,''),(566,'extension',0,1,' jpg '),(566,'filename',0,1,' shoplocalqc birkdale3 9 25 346 jpg '),(566,'kind',0,1,' image '),(566,'slug',0,1,''),(566,'title',0,1,' shop local qc birkdale3 9 25 346 '),(567,'alt',0,1,''),(567,'extension',0,1,' jpg '),(567,'filename',0,1,' southpark market october 2025 shop local qc cait louise co 284 jpg '),(567,'kind',0,1,' image '),(567,'slug',0,1,''),(567,'title',0,1,' south park market october 2025 shop local qc cait louise co 284 '),(568,'alt',0,1,''),(568,'extension',0,1,' jpg '),(568,'filename',0,1,' the bowl market july 2025 shop local qc cait louise co 113 jpg '),(568,'kind',0,1,' image '),(568,'slug',0,1,''),(568,'title',0,1,' the bowl market july 2025 shop local qc cait louise co 113 '),(574,'slug',0,1,' images '),(574,'title',0,1,' cakes '),(575,'slug',0,1,' the bowl market '),(575,'title',0,1,' the bowl market '),(576,'slug',0,1,' south park market '),(576,'title',0,1,' south park market '),(577,'slug',0,1,' cupcakes '),(577,'title',0,1,' cupcakes '),(578,'slug',0,1,' charlie '),(578,'title',0,1,' charlie '),(579,'slug',0,1,' shop local '),(579,'title',0,1,' shop local '),(589,'slug',0,1,' contact '),(589,'title',0,1,' contact '),(594,'slug',0,1,' temp ncixgrhgdtubmmbhfcrtjxjkueaegwhfswdj '),(594,'title',0,1,''),(595,'slug',0,1,''),(605,'slug',0,1,' temp biimcmbcbibayajldmksfqcgmrkdinkuhsol '),(605,'title',0,1,''),(606,'slug',0,1,''),(621,'slug',0,1,''),(631,'slug',0,1,' email '),(631,'title',0,1,' email '),(632,'slug',0,1,' location '),(632,'title',0,1,' location '),(633,'slug',0,1,' respons time '),(633,'title',0,1,' respons time '),(641,'handle',0,1,' subscribe '),(641,'slug',0,1,''),(641,'title',0,1,' subscribe '),(642,'handle',0,1,' sendusamessage '),(642,'slug',0,1,''),(642,'title',0,1,' send us a message '),(658,'slug',0,1,' temp asnsjpfpehlmontesieydyhxisczgksuzhmn '),(658,'title',0,1,''),(659,'slug',0,1,''),(663,'slug',0,1,' find us '),(663,'title',0,1,' find us '),(668,'slug',0,1,' temp jeisipknxpplvuwiolaujvmokuyezhyuzyme '),(668,'title',0,1,''),(669,'slug',0,1,''),(675,'slug',0,1,''),(687,'slug',0,1,' temp dbrwiurbjcxttodaehkpcnxejvjeksazlfrt '),(687,'title',0,1,''),(688,'slug',0,1,''),(700,'slug',0,1,' temp zoqvqdzhmtrzogwkzhpgbvwhtbkmuwtasjmj '),(700,'title',0,1,''),(701,'slug',0,1,''),(702,'slug',0,1,' online store '),(702,'title',0,1,' online store '),(703,'slug',0,1,' farmers markets '),(703,'title',0,1,' farmers markets '),(704,'slug',0,1,' events pop ups '),(704,'title',0,1,' events pop ups '),(705,'slug',0,1,' consignment '),(705,'title',0,1,' consignment ');
...
set autocommit=0;
INSERT INTO `sections` VALUES (1,NULL,'Home Page','homePage','single',1,1,1,'all','end','[{\"label\": \"Primary entry page\", \"refresh\": \"1\", \"urlFormat\": \"{url}\"}]','2026-03-25 13:57:24','2026-03-25 13:57:24',NULL,'b7f30bd9-4da3-41f0-8d17-26a2a6a0bf46'),(2,NULL,'Pages','pages','channel',1,1,1,'all','end','[{\"label\": \"Primary entry page\", \"refresh\": \"1\", \"urlFormat\": \"{url}\"}]','2026-05-09 22:02:04','2026-05-09 22:02:04',NULL,'a8354a78-8bd4-4740-a1e5-99da6ee4e9bd');
...
set autocommit=0;
INSERT INTO `sites` VALUES (1,1,1,'1','charlies','default','en',1,'$PRIMARY_SITE_URL',1,'2026-03-12 17:35:45','2026-05-20 13:02:39',NULL,'2589bc8f-a277-4da6-ae5f-f294f779bc87');
...
set autocommit=0;
INSERT INTO `tokens` VALUES (1,'T1KqPnne0fqq7oSU8L2_TJth1YgPGjS9','[\"preview\\/preview\",{\"elementType\":\"craft\\\\elements\\\\Entry\",\"canonicalId\":663,\"siteId\":1,\"draftId\":null,\"revisionId\":null,\"userId\":1}]',NULL,NULL,'2026-06-17 19:17:06','2026-06-16 19:17:06','2026-06-16 19:17:06','d50188fc-5aaf-4cb5-9a8f-82aeb0be3090');
...
set autocommit=0;
INSERT INTO `userpreferences` VALUES (1,'{\"locale\": null, \"language\": \"en\", \"timeZone\": null, \"useShapes\": false, \"weekStartDay\": \"1\", \"underlineLinks\": false, \"disableAutofocus\": \"\", \"profileTemplates\": false, \"showFieldHandles\": true, \"slideoutPosition\": \"end\", \"showExceptionView\": false, \"notificationDuration\": \"5000\", \"notificationPosition\": \"end-start\", \"enableDebugToolbarForCp\": true, \"enableDebugToolbarForSite\": true}');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,NULL,NULL,1,0,0,0,1,'admin',NULL,NULL,NULL,'jerry@charliesbarkery.com','$2y$13$W2qAPsTYHkeqfNKZNsh6F.x9w0kwBwf0UD0yM1m5vLCa7qTw0R7JC','2026-06-16 19:15:18',NULL,NULL,NULL,'2026-05-16 00:56:30',NULL,1,NULL,NULL,NULL,0,'2026-03-12 17:35:46','2026-03-12 17:35:46','2026-06-16 19:15:18');
...
-- Dump completed on 2026-06-16 16:30:35
